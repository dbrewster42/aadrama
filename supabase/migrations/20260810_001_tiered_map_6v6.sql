...
BEGIN
  ...
  WITH pool AS (
    SELECT * FROM (VALUES
      ...
      ('Dusk', 0.0630718954248366),
      ('Mountain Ambush', 0.0730718954248366),
      ('SF Hospital', 0.0602043010752688),
      ('SMU GH RiverVillage', 0.0602043010752688),
      ('[AA3] Impact', 0.0602043010752688),
      ('Weapons Cache SE', 0.0503369175627240),
      ...
      ('SF Dockside', 0.02002222222222222),
      ...
      ('Collapsed Tunnel', 0.0050000000000000),
