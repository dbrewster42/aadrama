...
BEGIN
  ...
  WITH pool AS (
    SELECT * FROM (VALUES
      ...
      ('Pipeline', 0.0088888888888889),
      ('Weapons Cache', 0.0080000000000000),
      ...
      ('Headquarters Raid', 0.0263398692810458),
      ('SF Sandstorm', 0.1096078431372549),
      ('Weapons Cache SE', 0.0980392156862750),
      ('Mountain Pass SE', 0.0032679738562092),
      ('Dusk', 0.0830718954248366),
      ('River Basin', 0.0265359477124183),
      ('Canyon', 0.0963398692810458),
      ('JRTC Farm Raid', 0.0143369175627240),
      ('Woodland Outpost', 0.0943369175627240),
      ('[AA3] Impact', 0.0543369175627240),
      ('Border', 0.0343369175627240),
      ('Radio Tower', 0.0035842293906810),
      ('SF Taiga', 0.0035842293906810),
      ('Bridge SE', 0.0357706093189964),
      ('SMU GH RiverVillage', 0.0372043010752688),
      ('SF Hospital', 0.0397777777777778),
      ...
      ('SMU GH SFRefinery', 0.00011111111111111),
